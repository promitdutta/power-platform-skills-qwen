...
```
node "${extensionPath}/scripts/dataverse-request.js" <envUrl> GET /api/data/v9.2/entities
```
...
```
node "${extensionPath}/scripts/dataverse-request.js" <envUrl> POST /api/data/v9.2/cr123_projects --body "{\"cr123_name\":\"My Project\"}"
```
