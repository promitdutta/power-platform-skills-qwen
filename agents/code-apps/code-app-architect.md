...
**📋 Shared Instructions: [shared-instructions.md](${extensionPath}/shared/shared-instructions.md)** - Cross-cutting concerns (Windows CLI, environment, planning, memory bank, execution style).
...
| read_file or write Excel workbook data                    | Excel Online (`/add-excel`)           |
| Upload, download, or manage files                    | OneDrive (`/add-onedrive`)            |
| read_file lists or manage documents in SharePoint         | SharePoint (`/add-sharepoint`)        |
