...
## Step 2 — read_file Current App State

read_file all `.pa.yaml` files in the working directory to understand the existing app:
...
3. "write_file plan document (canvas-edit-plan.md)"
...
## Step 7 — write_file canvas-edit-plan.md

write_file `canvas-edit-plan.md` to the working directory. This document is the **single source of
truth** for all `canvas-screen-editor` agents — each editor will only `read_file` this file and
