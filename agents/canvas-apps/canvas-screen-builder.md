...
read_file `canvas-app-plan.md` at the path provided in your invocation prompt.
...
Call `todo_write` for: "Implement [Screen Name] screen"

## Step 3 — write_file the Screen YAML

write_file `[ScreenName].pa.yaml` to the working directory.
