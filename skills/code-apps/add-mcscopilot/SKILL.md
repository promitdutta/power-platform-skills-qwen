...
Use `grep_search` to find specific methods in the generated service file (generated files can be very large — see [connector-reference.md](${extensionPath}/shared/connector-reference.md#inspecting-large-generated-files)).
