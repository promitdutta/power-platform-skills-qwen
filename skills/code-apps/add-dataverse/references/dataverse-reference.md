...
Critical patterns for working with Dataverse in Power Apps code apps. **read_file this before writing any Dataverse code.**
...
```typescript
// CORRECT - read_file the related record's GUID via _value property
