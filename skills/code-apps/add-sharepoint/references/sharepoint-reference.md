...
Critical patterns for working with SharePoint lists in Power Apps code apps. **read_file this before writing any SharePoint code.**
...
| Calculated       | Calculated             | read_file-only             | Server-computed, cannot set via API |
