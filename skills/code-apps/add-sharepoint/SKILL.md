...
Present findings to user with `ask_user_question`:
...
Find the SharePoint Online connection ID (see [connector-reference.md](${extensionPath}/shared/connector-reference.md)):
...
**read_file [sharepoint-reference.md](./references/sharepoint-reference.md) before writing any SharePoint code** -- column encoding, choice fields, and lookups have critical gotchas.
...
Use `grep_search` to find specific methods in `src/generated/services/SharePointOnlineService.ts` (generated files can be very large -- see [connector-reference.md](${extensionPath}/shared/connector-reference.md#inspecting-large-generated-files)).
