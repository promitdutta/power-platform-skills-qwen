...
user-invocable: true
allowed-tools: read_file, write_file, edit, run_shell_command, Task, todo_write, todo_write, todo_write, mcp__canvas-authoring__compile_canvas
---
...
>
> Follow the instructions in your agent file. write_file canvas-app-plan.md and App.pa.yaml to
...
> - Working directory: [absolute path from Phase 0]
>
> Follow the instructions in your agent file. write_file [ScreenName].pa.yaml and return your
